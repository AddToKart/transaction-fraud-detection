    ...
    <footer className="bg-gray-800 text-white p-8 mt-auto">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-semibold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-4">Transaction Fraud Detection</h3>
            <p className="text-gray-400 text-sm mb-4">Powered by Gemini AI & Polkadot</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>support@frauddetection.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Transaction Fraud Detection. All rights reserved.
          </div>
